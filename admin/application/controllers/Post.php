...
class Post extends MY_Controller {
    ...
    private function initializeInputFieldValues($id = 0) {
        ...
        if ($id == 0) {
            ...
            $row = $this->post_model->getRowByColumnArray($this->uri->segment(1).'id',$id);
    ...
    public function deleteimage() {
        ...
        echo $this->post_model->deletefile($this->uri->segment(1).'id',$_POST['id'],$_POST['columnname'],$_POST['filename'],$_POST['t']);
    ...
    public function phpexcel_export(){
        ...
        //if(isset($_POST['export'])){
            ...
            $columnlistArray = $this->post_model->getAllColumnArray($id);

            $export_data = $this->post_model->getAllAvailableArray();
	...
	public function index() {
        ...
        $this->viewData['columnlist'] = $this->post_model->getAllColumnArray($id);

        $this->viewData['records'] = $this->post_model->getAllAvailableArray($limit_per_page,$start_index);
    ...
    public function view($id) {
        ...
        $this->viewData['records'] = $this->post_model->getRowByColumn($this->uri->segment(1).'id',$id);
    ...
    public function edit($id) {
        ...
        if (isset($_POST['insert'])) {
            ...
            unset($post['insert']);
            $post['slug'] = $this->get_Title($this->input->post('posttitle'));
            $post['seotitle'] = $this->input->post('posttitle');

            $inserted = $this->post_model->update($id,$post);
        ...
        $this->viewData['records'] = $this->post_model->getRowByColumn('postid',$id);
    ...
    public function delete($id) {
        ...
        $this->post_model->delete($this->uri->segment(1).'id',$id);

        $this->session->set_flashdata('flash_success_msg', 'The Financial Service has been deleted successfully.');
    ...
    public function deleteAll() {
        ...
        $this->post_model->delete($this->uri->segment(1).'id',$this->input->post('ckbdelete'));
    ...
    public function download(){
        ...
        $csvResultOfProjects = $this->post_model->getAllAvailableArrayDownload();
    ...
    public function add() {
        ...
        if (isset($_POST['insert'])) {
            ...
            $post['slug'] = $this->get_Title($this->input->post('posttitle'));
            $post['seotitle'] = $this->input->post('posttitle');
            $inserted = $this->post_model->insert($post);

            $moduleid = $this->viewData['module']->moduleid;

            if($inserted){

                $this->session->set_flashdata('flash_success_msg', 'The Financial Service Icon has been added successfully.');
