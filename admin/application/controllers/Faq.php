...
class Faq extends MY_Controller {
    ...
    private function initializeInputFieldValues($id = 0) {
        ...
        if ($id == 0) {
            ...
            $row = $this->faq_model->getRowByColumnArray($this->uri->segment(1).'id',$id);
    ...
    public function deleteimage() {
        ...
        echo $this->faq_model->deletefile($this->uri->segment(1).'id',$_POST['id'],$_POST['columnname'],$_POST['filename'],$_POST['t']);
    ...
    public function phpexcel_export(){
        ...
        //if(isset($_POST['export'])){
            ...
            $columnlistArray = $this->faq_model->getAllColumnArray($id);

            $export_data = $this->faq_model->getAllAvailableArray();
	...
	public function index() {
        ...
        $total_records = $this->faq_model->get_total();
        ...
        $this->viewData['columnlist'] = $this->faq_model->getAllColumnArray($id);

        $this->viewData['records'] = $this->faq_model->getAllAvailableArray($limit_per_page,$start_index);
    ...
    public function view($id) {
        ...
        $this->viewData['records'] = $this->faq_model->getRowByColumn($this->uri->segment(1).'id',$id);
    ...
    public function edit($id) {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->faq_model->update($id,$post);
        ...
        $this->viewData['records'] = $this->faq_model->getRowByColumn('faqid',$id);
    ...
    public function delete($id) {
        ...
        $this->faq_model->delete($this->uri->segment(1).'id',$id);

        $this->session->set_flashdata('flash_success_msg', 'The faq has been deleted successfully.');
    ...
    public function deleteAll() {
        ...
        $this->faq_model->delete($this->uri->segment(1).'id',$this->input->post('ckbdelete'));
    ...
    public function download(){
        ...
        $csvResultOfProjects = $this->faq_model->getAllAvailableArrayDownload();
    ...
    public function add() {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->faq_model->insert($post);

            $moduleid = $this->viewData['module']->moduleid;

            if($inserted){

                $this->session->set_flashdata('flash_success_msg', 'The New faq has been added successfully.');
