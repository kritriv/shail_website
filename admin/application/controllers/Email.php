...
class Email extends MY_Controller {
    ...
    private function initializeInputFieldValues($id = 0) {
        ...
        if ($id == 0) {
            ...
            $row = $this->email_model->getRowByColumnArray($this->uri->segment(1).'id',$id);
    ...
    public function phpexcel_export(){
        ...
        //if(isset($_POST['export'])){
            ...
            $columnlistArray = $this->email_model->getAllColumnArray($id,'sequence');

            $export_data = $this->email_model->getAllAvailableArray();
	...
	public function index() {
        ...
        $total_records = $this->email_model->get_total();
        ...
        $this->viewData['columnlist'] = $this->email_model->getAllColumnArray($id);

        $this->viewData['records'] = $this->email_model->getAllAvailableArray($limit_per_page,$start_index);
    ...
    public function view($id) {
        ...
        $this->viewData['records'] = $this->email_model->getRowByColumn($this->uri->segment(1).'id',$id);
    ...
    public function deleteimage() {
        ...
        echo $this->email_model->deletefile($this->uri->segment(1).'id',$_POST['id'],$_POST['columnname'],$_POST['filename'],$_POST['t']);
    ...
    public function edit($id) {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->email_model->update($id,$post);
        ...
        $this->viewData['records'] = $this->email_model->getRowByColumn('emailid',$id);
    ...
    public function delete($id) {
        ...
        $this->email_model->delete($this->uri->segment(1).'id',$id);

        $this->session->set_flashdata('flash_success_msg', 'The email has been deleted successfully.');
    ...
    public function deleteAll() {
        ...
        $this->email_model->delete($this->uri->segment(1).'id',$this->input->post('ckbdelete'));
    ...
    public function download(){
        ...
        $csvResultOfProjects = $this->email_model->getAllAvailableArrayDownload();
    ...
    public function add() {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->email_model->insert($post);

            $moduleid = $this->viewData['module']->moduleid;

            if($inserted){

                $this->session->set_flashdata('flash_success_msg', 'The New email has been added successfully.');
