...
class enquiry extends MY_Controller {
    ...
    private function initializeInputFieldValues($id = 0) {
        ...
        if ($id == 0) {
            ...
            $row = $this->enquiry_model->getRowByColumnArray($this->uri->segment(1).'id',$id);
    ...
    public function phpexcel_export(){
        ...
        //if(isset($_POST['export'])){
            ...
            $columnlistArray = $this->enquiry_model->getAllColumnArray($id,'sequence');

            $export_data = $this->enquiry_model->getAllAvailableArray($_GET);
	...
	public function index() {
        ...
        $total_records = $this->enquiry_model->get_total($_GET);
        ...
        $this->viewData['columnlist'] = $this->enquiry_model->getAllColumnArray($id);

        $this->viewData['records'] = $this->enquiry_model->getAllAvailableArray($_GET,$limit_per_page,$start_index);
    ...
    public function view($id) {
        ...
        $this->viewData['records'] = $this->enquiry_model->getRowByColumn($this->uri->segment(1).'id',$id);
    ...
    public function edit($id) {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->enquiry_model->update($id,$post);
    ...
    public function delete($id) {
        ...
        $this->enquiry_model->delete($this->uri->segment(1).'id',$id);

        $this->session->set_flashdata('flash_success_msg', 'The Coupon has been deleted successfully.');
    ...
    public function deleteAll() {
        ...
        $this->enquiry_model->delete($this->uri->segment(1).'id',$this->input->post('ckbdelete'));
    ...
    public function download(){
        ...
        $csvResultOfProjects = $this->enquiry_model->getAllAvailableArrayDownload();
    ...
    public function deleteimage() {
        ...
        echo $this->enquiry_model->deletefile($this->uri->segment(1).'id',$_POST['id'],$_POST['columnname'],$_POST['filename'],$_POST['t']);
    ...
    public function add() {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->enquiry_model->insert($post);

            $moduleid = $this->viewData['module']->moduleid;

            if($inserted){

                $this->session->set_flashdata('flash_success_msg', 'The New Enquiry has been added successfully.');
