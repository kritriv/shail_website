...
class Website extends MY_Controller {
    ...
    private function initializeInputFieldValues($id = 0) {
        ...
        if ($id == 0) {
            ...
            $row = $this->website_model->getRowByColumnArray($this->uri->segment(1).'id',$id);
    ...
    public function deleteimage() {
        ...
        echo $this->website_model->deletefile($this->uri->segment(1).'id',$_POST['id'],$_POST['columnname'],$_POST['filename'],$_POST['t']);
    ...
    public function phpexcel_export(){
        ...
        //if(isset($_POST['export'])){
            ...
            $columnlistArray = $this->website_model->getAllColumnArray($id,'sequence');

            $export_data = $this->website_model->getAllAvailableArray($_GET);
	...
	public function index() {
        ...
        $total_records = $this->website_model->get_total($_GET);
        ...
        $this->viewData['columnlist'] = $this->website_model->getAllColumnArray($id);

        $this->viewData['records'] = $this->website_model->getAllAvailableArray($_GET,$limit_per_page,$start_index);
    ...
    public function view($id) {
        ...
        $this->viewData['records'] = $this->website_model->getRowByColumn($this->uri->segment(1).'id',$id);
    ...
    public function edit($id) {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->website_model->update($id,$post);
        ...
        $this->viewData['records'] = $this->website_model->getRowByColumn('websiteid',$id);
    ...
    public function delete($id) {
        ...
        $this->website_model->delete($this->uri->segment(1).'id',$id);

        $this->session->set_flashdata('flash_success_msg', 'The website Details has been deleted successfully.');
    ...
    public function deleteAll() {
        ...
        $this->website_model->delete($this->uri->segment(1).'id',$this->input->post('ckbdelete'));
    ...
    public function download(){
        ...
        $csvResultOfProjects = $this->website_model->getAllAvailableArrayDownload();
    ...
    public function add() {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->website_model->insert($post);

            $moduleid = $this->viewData['module']->moduleid;

            if($inserted){

                $this->session->set_flashdata('flash_success_msg', 'The website have been added successfully.');
