...
class Faqf extends MY_Controller {

	function __construct() {

        parent::__construct();

        $this->load->model('faqf_model', '', TRUE);
    ...
    private function initializeInputFieldValues($id = 0) {
        ...
        if ($id == 0) {
            ...
            $row = $this->faqf_model->getRowByColumnArray($this->uri->segment(1).'id',$id);
    ...
    public function deleteimage() {
        ...
        echo $this->faqf_model->deletefile($this->uri->segment(1).'id',$_POST['id'],$_POST['columnname'],$_POST['filename'],$_POST['t']);
    ...
    public function phpexcel_export(){
        ...
        //if(isset($_POST['export'])){
            ...
            $columnlistArray = $this->faqf_model->getAllColumnArray($id);

            $export_data = $this->faqf_model->getAllAvailableArray();
	...
	public function index() {
        ...
        $total_records = $this->faqf_model->get_total();
        ...
        $this->viewData['columnlist'] = $this->faqf_model->getAllColumnArray($id);

        $this->viewData['records'] = $this->faqf_model->getAllAvailableArray($limit_per_page,$start_index);
    ...
    public function view($id) {
        ...
        $this->viewData['records'] = $this->faqf_model->getRowByColumn($this->uri->segment(1).'id',$id);
    ...
    public function edit($id) {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->faqf_model->update($id,$post);
        ...
        $this->viewData['records'] = $this->faqf_model->getRowByColumn('faqfid',$id);
    ...
    public function delete($id) {
        ...
        $this->faqf_model->delete($this->uri->segment(1).'id',$id);

        $this->session->set_flashdata('flash_success_msg', 'The faqf has been deleted successfully.');
    ...
    public function deleteAll() {
        ...
        $this->faqf_model->delete($this->uri->segment(1).'id',$this->input->post('ckbdelete'));
    ...
    public function download(){
        ...
        $csvResultOfProjects = $this->faqf_model->getAllAvailableArrayDownload();
    ...
    public function add() {
        ...
        if (isset($_POST['insert'])) {
            ...
            $inserted = $this->faqf_model->insert($post);

            $moduleid = $this->viewData['module']->moduleid;

            if($inserted){

                $this->session->set_flashdata('flash_success_msg', 'The New faqf has been added successfully.');
